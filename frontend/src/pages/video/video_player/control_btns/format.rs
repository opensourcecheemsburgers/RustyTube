...
pub fn FormatDropdown(formats: Vec<VideoFormat>) -> impl IntoView {
	view! {        <div class="dropdown dropdown-top dropdown-end z-20">
            <DropdownBtn />
...
pub fn DropdownBtn() -> impl IntoView {
    view! {        <label tabindex="0" class="btn btn-ghost btn-xs">
            <CogIcon />
        </label>
    }
}
...
pub fn DropdownContent(formats: Vec<VideoFormat>) -> impl IntoView {
    view! {        <ul tabindex="0" class="menu dropdown-content mb-4 px-1.5 py-3 shadow bg-base-200 rounded-xl w-max h-max">
...
pub fn ListItem(children: Children) -> impl IntoView {
    view! {        <button class="btn btn-sm lowercase btn-ghost">
            {children()}
        </button>
    }
}
...
pub fn VideoFormatList(formats: Vec<VideoFormat>) -> impl IntoView {
    view! {        <div class="flex flex-col bg-base-200">
        {
