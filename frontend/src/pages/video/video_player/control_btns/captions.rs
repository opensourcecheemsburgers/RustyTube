...
pub fn CaptionsDropdownContent(captions: Vec<Caption>) -> impl IntoView {
    view! {        <ul tabindex="0" class="menu dropdown-content py-3 mb-4 mr-2 shadow bg-base-300 rounded-xl w-max h-auto max-h-48">
...
pub fn CaptionsDropdownItem(caption: Caption) -> impl IntoView {
    ...
    view! {        <div class="p-3 rounded-lg bg-base-100 cursor-pointer">
