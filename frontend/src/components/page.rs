...
pub fn Page(children: Children) -> impl IntoView {
    ...
    view! {        <div data-theme={theme} class="flex flex-row min-h-screen max-h-screen bg-base-100 min-w-screen max-w-screen">
            <Sidebar/>
...
pub fn ScrollablePage(children: Children) -> impl IntoView {
    ...
    view! {        <div data-theme={theme} class="flex flex-row min-h-screen max-h-screen bg-base-100">
            <Sidebar/>
            <div data-expanded=expanded class=PAGE_CLASSES>
                <Header />
