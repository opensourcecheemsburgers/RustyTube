...
pub fn DonateModal() -> impl IntoView {
    view! {
        <dialog id=DONATE_MODAL_ID class="modal">
            <div class="modal-box">
                <div class="flex flex-col space-y-4">
                    <h1 class="text-xl font-bold">Support RustyTube</h1>
                    <div class="flex flex-col space-y-8">
                        <p>
                            RustyTube is a free and open-source project. It has taken hundreds of hours in development time. Support the project and its further development.
                        </p>
                        <div class="flex flex-col space-y-4">
                            <h2 class="text-lg font-semibold">Liberapay</h2>
